        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Clear and transparent policies for subscription cancellations and
              refunds
            </p>
          ...
          <div className="prose prose-lg max-w-none">
              ...
              <div className="flex">
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    <strong>Quick Summary:</strong> You can cancel your
                    subscription anytime. Refunds are generally not provided for
                    subscription fees already paid, except as required by law or
                    in special circumstances outlined below.
                  </p>
                </div>
              </div>
            </div>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                You may cancel your AIAgentStudio.AI subscription at any time
                through:
              </p>
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                ...
                <li>
                  Your account automatically converts to our free plan at the
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-6">
                ...
                non-refundable. This policy helps us maintain competitive
                pricing and continue developing new features for all users.
              </p>
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                <li>
                  <strong>Technical Issues:</strong> Extended service outages
                  lasting more than 72 consecutive hours
                </li>
                <li>
                  <strong>Billing Errors:</strong> Incorrect charges due to
                  system errors on our part
                </li>
                <li>
                  <strong>Duplicate Charges:</strong> Accidental multiple
                  billing for the same period
                </li>
                <li>
                  <strong>Legal Requirements:</strong> Where refunds are
                  required by applicable consumer protection laws
                </li>
                <li>
                  <strong>First-Time Users:</strong> 7-day satisfaction
                  guarantee for new subscribers (see details below)
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                First-time subscribers to any paid plan are eligible for a full
                refund if:
              </p>
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                <li>
                  You request the refund within 7 days of your initial
                  subscription
                </li>
                <li>
                  You have not previously held a paid subscription with
                  AIAgentStudio.AI
                </li>
                <li>You contact our support team with your refund request</li>
                <li>
                  You provide brief feedback about your experience (optional but
                  appreciated)
                </li>
              </ul>

              <p className="text-gray-600 mb-6">
                This guarantee applies only to the first billing period and
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                <li>
                  Charges are based on actual usage and are non-refundable
                </li>
                <li>
                  You will receive clear notifications before incurring usage
                  charges
                </li>
                <li>
                  Usage limits and spending caps can be set in your account
                  settings
                </li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                ...
                <li>
                  Bank transfers may take 7-10 business days depending on your
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                <li>
                  Your account data is preserved and accessible on the free plan
                </li>
                <li>
                  AI agents and workflows remain saved but may have usage
                  limitations
                </li>
                <li>
                  You can request complete account deletion by contacting
                  support
                </li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-6">
                ...
                applicable consumer protection laws. In some jurisdictions, you
                may have additional rights including:
              </p>
              <ul className="list-disc pl-6 mb-6 text-gray-600">
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                ...
                <li>
                  Seek resolution through applicable consumer protection
                  agencies
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="text-gray-600 space-y-2">
                  <li>
                    <strong>Email:</strong> support@aiagentstudio.ai
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Response Time:</strong> Within 24 hours for billing
                    inquiries
                  </li>
                </ul>
              </div>
