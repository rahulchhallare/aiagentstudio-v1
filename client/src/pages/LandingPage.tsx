...
// Icons
import { 
  Grip, BrainIcon, RocketIcon, 
  Folder, BarChartIcon, UsersIcon 
} from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-12 mb-10 md:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Create, deploy, and manage custom AI agents with a simple drag-and-drop interface. No technical expertise required.
              </p>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
            <div className="text-gray-400 font-medium text-lg">ACME Inc.</div>
            <div className="text-gray-400 font-medium text-lg">TechCorp</div>
            <div className="text-gray-400 font-medium text-lg">InnovateAI</div>
            <div className="text-gray-400 font-medium text-lg">FutureSystems</div>
            <div className="text-gray-400 font-medium text-lg">NextWave</div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 hover:shadow-md transition duration-200">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">GPT Integration</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 hover:shadow-md transition duration-200">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Collaborative Workspace</h3>
              <p className="text-gray-600">
                Work together with your team to build, test, and refine agent workflows.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="md:w-2/5 mb-10 md:mb-0">
              <div className="space-y-8">
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-primary-100 rounded-full w-10 h-10 flex items-center justify-center text-primary-600 font-bold mr-4">1</div>
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Design your flow</h3>
                    <p className="text-gray-600">
                      Drag input, processing, and output blocks onto the canvas and connect them in a logical flow.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Configure AI behavior</h3>
                    <p className="text-gray-600">
                      Set up GPT blocks with the right prompts and parameters to achieve your desired outcomes.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Test and refine</h3>
                    <p className="text-gray-600">
                      Use the built-in testing tools to validate your agent's performance and make adjustments.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Deploy your agent with one click and monitor its performance in real-time with analytics.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-primary-200 flex flex-col relative scale-105 z-10">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  ...
                  <span>2,000 GPT API calls/month</span>
                </li>
                <li className="flex items-start">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-200 flex flex-col">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  ...
                  <span>10,000 GPT API calls/month</span>
                </li>
                <li className="flex items-start">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover how AIagentStudio.ai is transforming workflows for teams around the world.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "AIagentStudio has completely transformed how we handle customer support. We built an agent in just a few hours that now handles 80% of routine inquiries."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
                  <h4 className="font-medium text-gray-900">Sarah Johnson</h4>
                  <p className="text-gray-500 text-sm">CTO, TechSupport Inc</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "As someone with no coding background, I was able to create a sophisticated AI content generator that's now a central part of our marketing strategy."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
                  <h4 className="font-medium text-gray-900">Michael Rodriguez</h4>
                  <p className="text-gray-500 text-sm">Marketing Director, GrowthMedia</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "The visual builder makes it incredibly easy to design complex AI workflows. We've deployed multiple agents that have significantly reduced our operational costs."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
                  <h4 className="font-medium text-gray-900">David Chen</h4>
                  <p className="text-gray-500 text-sm">Operations Lead, LogisticsPro</p>
                </div>
              </div>
            </div>
          </div>
