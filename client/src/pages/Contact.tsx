        ...
        <section className="bg-gradient-to-b from-primary-50 to-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Have questions about AIAgentStudio.AI? Need help with your AI
              agents? We're here to help you succeed.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  business days. For urgent technical issues, our live chat
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Yes, we offer phone support for enterprise customers and
                  complex technical issues. Contact us to schedule a call.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600 mb-6">
                  Absolutely! We offer personalized demos for teams and
                  enterprises. Select "Sales Inquiry" in the form above to
                  request a demo.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Our comprehensive documentation is available in the Resources
                  section. You can also access tutorials and API references
                  there.
                </p>
              </div>
            </div>
