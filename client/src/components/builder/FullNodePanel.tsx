    ...
    <div className="w-full h-full bg-background border-r overflow-y-auto p-4">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            <div 
              className="p-3 bg-orange-50 border border-orange-200 text-orange-600 rounded-lg cursor-pointer hover:shadow-sm transition-shadow flex items-center"
              draggable
              onDragStart={(event) => onDragStart(event, 'huggingFaceNode')}
              onClick={() => addNode('huggingFaceNode')}
            >
              ...
              <div>
                ...
                <div className="text-xs text-orange-500">Free AI text generation</div>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-purple-500">Local AI models</div>
              </div>
            </div>
          </div>
        </div>
